...
for (i = 0; i < lengthOf(filelist); i++) {
    if (endsWith(filelist[i], "_stage0.tif")) { 		//Choose the original file here
...
CurrentFile = replace(OriginalTitle,"_stage0.tif","_stage1.tif");	//Here is wher you define the already segmented file that is to be corrected
